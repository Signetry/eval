...
class CaseScore:
    ...
    def to_public(self) -> dict:
        return {
            ...
            "is_safe": self.is_safe, "expected": self.expected, "detected": self.detected,
...
class CorpusScore:
    ...
    def recall(self) -> float:
        return round(self.detected_total / self.expected_total, 4) if self.expected_total else 0.0
